      ...
      <Container className="container">
        ...
        >
          {site === 1 ? (
            ...
            <Nav>
              {(role === 1 || role === 3) && (
                <Link className="linktag" to="/sales/mydemocall">
                  My Demo Calls
                </Link>
              )}
              {role === 1 && (
                <Link className="linktag" to="/sales/assginedsalescall">
                  My Sales Calls
                </Link>
              )}
              {role === 1 && (
                <Link className="linktag" to="/sales/democall">
                  Assigned Demo Calls
                </Link>
              )}
              {role === 3 && (
                <Link className="linktag" to={"/sales/company"}>
                  Company
                </Link>
              )}
              {role === 3 && (
                <Link className="linktag" to="/sales/employee">
                  Employee
                </Link>
              )}
              {role === 3 && (
                <Link className="linktag" to="/sales/salescall">
                  Sales Call
                </Link>
              )}
              {role === 3 && (
                <Link className="linktag" to="/sales/managerdemo">
                  Demo Call
                </Link>
              )}
